                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: Color(0xffFF9B51), width: 2),
                      ),
                      child: Center(
                        child: Icon(
                          Icons.checkroom,
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: Color(0xff578FCA), width: 2),
                      ),
                      child: Center(
                        child: Icon(
                          Icons.hiking,
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: Color(0xffF16767), width: 2),
                      ),
                      child: Center(
                        child: Icon(
                          Icons.work_outline,
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: Color(0xffFACC15), width: 2),
                      ),
                      child: Center(
                        child: Icon(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: Color(0xffE2B59A), width: 2),
                      ),
                      child: Center(
                        child: Icon(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: Color(0xff758A93), width: 2),
                      ),
                      child: Center(
                        child: Icon(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: Color(0xffBBDCE5), width: 2),
                      ),
                      child: Center(
                        child: Icon(
